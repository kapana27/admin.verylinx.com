app.controller('advertiserCtrl', function($scope,$http,$moment){
    $scope.page = {
        title: 'advertiser',
        subtitle: 'dashboard...'
    };
    ...
    $scope.GetTransactionInfo=function () {
        ...
        $http.post('/advertiser/dashboard_Get_transaction_info',$scope.filter).then(function(response){
    ...
    $scope.incomingStat=function () {
        ...
        $http.post('/advertiser/dashboard_incomingStat',$scope.filter).then(function(response){
            if(response.data.res=="yes"){
    ...
    $scope.GetAmountWithCompanies=function () {
        $scope.donutdataset=[];
        $scope.donut=[];
        $http.post('/advertiser/GetAmountWithCompanies',$scope.filter).then(function(response){
            if(response.data.res=="yes"){
    ...
    $scope.GetDifferentReport=function () {
        ...
        $http.post('/advertiser/GetMaxCompany',$scope.filter).then(function(response){
           if(response.data.res=='yes'){
    ...
    $scope.GetCategoryDifferent=function(){
        ...
        $http.post('/advertiser/GetCategoryDifferent',$scope.filter).then(function(response){
            if(response.data.res=="yes"){
				$scope.areaData = [
					{ 
